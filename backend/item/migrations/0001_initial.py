    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('poster', models.ImageField(null=True, upload_to='item/%Y/%m')),
                ('backdrop', models.ImageField(null=True, upload_to='item/%Y/%m')),
            ],
        ),
        migrations.CreateModel(
            name='Item',
            fields=[
                ...
                ('image', models.ImageField(blank=True, upload_to='item/%Y/%m', verbose_name='상품 사진')),
        ...
        migrations.AddField(
            model_name='order',
            name='coupon_hold',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.couponhold', verbose_name='쿠폰 내역'),
        ),
        migrations.AddField(
            model_name='order',
            name='item',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.noncouponhold', verbose_name='비쿠폰 내역'),
        ),
        migrations.AddField(
            model_name='order',
            name='profile',
