...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='movie.Distributor'),
        ),
        migrations.AddField(
            model_name='profile',
        ...
        migrations.AddField(
            ...
            name='department',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='direct_department', to='accounts.department'),
        ),
        migrations.AddField(
